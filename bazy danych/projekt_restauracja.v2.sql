...
--
-- Host: 127.0.0.1
-- Czas generowania: 16 Mar 2018, 11:34
...
CREATE TABLE `kategorie` (
  `IdKatategori` int(11) NOT NULL,
  `NazwaKatategori` varchar(32) DEFAULT NULL,
  `KolorKategori` char(6) DEFAULT NULL
...
INSERT INTO `kategorie` (`IdKatategori`, `NazwaKatategori`, `KolorKategori`) VALUES
...
--
-- Struktura tabeli dla tabeli `pozycja_menu`
--
...
CREATE TABLE `pozycja_menu` (
  ...
  `DataArchiwizacji` datetime DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Zrzut danych tabeli `pozycja_menu`
--

INSERT INTO `pozycja_menu` (`IdPozycjiMenu`, `IdProduktu`, `CenaBrutto`, `IdVAT`, `DataWprowadzenia`, `DataArchiwizacji`) VALUES
...
INSERT INTO `pozycja_zamowienia` (`IdZamowienia`, `IdPozycjiMenu`, `LiczbaProduktu`, `StanRealizacji`) VALUES
(2, 10, 2, NULL),
(3, 9, 5, NULL),
(3, 11, 10, NULL),
(4, 12, 4, NULL),
...
CREATE TABLE `produkty` (
  ...
  `SposobPrzygotowania` varchar(255) DEFAULT NULL,
  `Opis` varchar(255) DEFAULT NULL,
  `KolorProduktu` varchar(6) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
INSERT INTO `produkty` (`IdProduktu`, `NazwaProduktu`, `IdKategori`, `SposobPrzygotowania`, `Opis`, `KolorProduktu`) VALUES
...
CREATE TABLE `sektory` (
  ...
  `NazwaSkektoru` varchar(32) DEFAULT NULL,
...
INSERT INTO `sektory` (`IdSektora`, `NazwaSkektoru`, `Aktywny`) VALUES
(1, 'patio', 1),
(2, 'piwnica', 0),
(3, 'sala główna', 1);
...
INSERT INTO `stoliki` (`IdStolika`, `NazwaStolika`, `LiczbaMiejsc`, `IdSektora`) VALUES
(1, 'pat6', 6, 1),
(2, 'piw6', 6, 2),
(3, 'pat8', 8, 1),
(4, 'sgl3', 3, 3),
...
INSERT INTO `zamowienia` (`IdZamowienia`, `IdStolika`, `UwagiPracownika`, `UwagiGoscia`, `DataOtwarcia`, `DataZamkniecia`, `IdStegoKlienta`) VALUES
(2, 3, NULL, NULL, NULL, NULL, 0),
(3, 1, NULL, NULL, NULL, NULL, 0),
(4, 2, NULL, NULL, NULL, NULL, 0),
(5, 1, NULL, NULL, '2018-01-15 23:36:23', NULL, 0),
(6, 1, NULL, NULL, '2018-01-16 12:16:09', NULL, 0),
(7, 1, NULL, NULL, '2018-01-16 09:51:03', NULL, 0),
(8, 1, NULL, NULL, '2018-01-16 10:51:35', NULL, 0),
(9, 1, NULL, NULL, '2018-01-16 10:54:44', NULL, 0),
(10, 1, NULL, NULL, '2018-01-16 10:55:28', NULL, 0),
(11, 1, NULL, NULL, '2018-01-16 10:55:38', NULL, 0),
(12, 4, NULL, NULL, '2018-01-16 11:09:27', NULL, 0),
(13, 4, NULL, NULL, '2018-01-16 13:30:23', NULL, 0),
(14, 5, NULL, NULL, '2018-01-16 13:35:12', NULL, 0),
(15, 4, NULL, NULL, '2018-01-17 10:25:04', NULL, 0),
(16, 4, NULL, NULL, '2018-01-17 10:40:19', NULL, 0),
(17, 4, NULL, NULL, '2018-01-17 10:41:46', NULL, 0),
(18, 4, NULL, NULL, '2018-01-17 11:06:25', NULL, 0),
(19, 5, NULL, NULL, '2018-01-17 13:26:15', NULL, 0),
(20, 4, NULL, NULL, '2018-01-17 14:02:01', NULL, 0),
(21, 4, NULL, NULL, '2018-01-17 14:11:05', NULL, 0),
(22, 4, NULL, NULL, '2018-01-17 14:34:16', NULL, 0),
(23, 4, NULL, NULL, '2018-01-17 20:44:37', NULL, 0),
(24, 4, NULL, NULL, '2018-01-22 22:10:41', NULL, 0),
(25, 4, NULL, NULL, '2018-01-22 22:44:12', NULL, 0),
(26, 4, NULL, NULL, '2018-01-23 11:49:36', NULL, 0),
(27, 4, NULL, NULL, '2018-01-23 11:50:38', NULL, 0),
(28, 4, NULL, NULL, '2018-01-23 11:53:56', NULL, 0),
(29, 4, NULL, NULL, '0000-00-00 00:00:00', NULL, 0),
(30, 4, NULL, NULL, '2018-01-23 13:26:04', NULL, 0),
(31, 4, NULL, NULL, '2018-01-23 13:50:05', NULL, 0),
(32, 4, NULL, NULL, '2018-01-23 14:04:43', NULL, 0),
(33, 4, NULL, NULL, '2018-01-23 14:10:02', NULL, 0),
(34, 4, NULL, NULL, '2018-02-23 20:10:59', NULL, 0),
(35, 4, NULL, NULL, '2018-02-23 20:21:52', NULL, 0),
(36, 4, NULL, NULL, '2018-03-07 23:03:45', NULL, 0),
(37, 4, NULL, NULL, '2018-03-07 23:19:21', NULL, 0),
(38, 4, NULL, NULL, '2018-03-07 23:24:46', NULL, 0),
(39, 4, NULL, NULL, '2018-03-08 12:02:36', NULL, 0);
...
--
-- Indeksy dla tabeli `pozycja_menu`
--
ALTER TABLE `pozycja_menu`
...
ALTER TABLE `sektory`
  ...
  ADD UNIQUE KEY `NazwaSkektoru` (`NazwaSkektoru`);
