...
CREATE DATABASE IF NOT EXISTS `projekt_restauracja` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
...
INSERT INTO `stali_klienci` (`ID_K`, `Email`, `Haslo`, `Imie`, `Nazwisko`) VALUES
