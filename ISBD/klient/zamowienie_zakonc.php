...
<head>
	...
	<script type="text/javascript">
		...
		function myMain()
		{
			document.getElementById("wqrt").innerHTML = "Łączna watość rachunku wyniosła "+(wart).toFixed(2)+" zł," ;
			document.getElementById("platnosc").innerHTML = "prosimy przygotować "+platnosc+"." ;
			zegar();
		}

		function zakonc()
		{
			if(window.confirm("Uwaga do tego okna już nie będzie można powrócić, czy chcesz kontynułować?"))
			{
...
<body>
	...
	<div class="b20px">
		Mamy nadziję, że wszystko Państwu smakowało,
	</div>
	<div class="b20px">
		zaraz do Państwa podejdzie kelner z rachunkiem.
	</div>
	<div id="wqrt" class="b20px"></div>
