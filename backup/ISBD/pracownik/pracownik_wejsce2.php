...
<body>
	<div class="flexboix">
		<div class="kat">
			<div id="nKat" class="nav">
				<button id="sub1" class="cBattonNav1" onclick="zamPods()" disabled>Zamówienie</button>
				<button class="cBattonNav"  onclick="kafelki(kategorie())">Kategorie</button>
