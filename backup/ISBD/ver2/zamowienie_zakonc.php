...
<head>
	...
	<script type="text/javascript">
		...
		function myMain()
		{
			document.getElementById("platnosc").innerHTML = "Łączna watość rachunku wyniosła "+(wart).toFixed(2)+" zł, prosimy przygotować "+platnosc+"." ;
			zegar();
		}
...
<body>
	...
	<div class="b20px">
		Dziękujemy za wizytę w naszej restauracji. Mamy nadziję, że wszystko Państwu smakowało, zaraz do Państwa podejdzie kelner z rachunkiem.
	</div>
	<br>
