...
--
-- Host: 127.0.0.1
-- Czas generowania: 21 Sty 2018, 15:29
...
(1, 1, 1, '20:30:00', '2018-03-01'),
(2, 4, 1, '12:00:00', '2018-03-01'),
(3, 4, 1, '12:00:00', '2018-03-07'),
(4, 1, 1, '20:30:00', '2018-03-05'),
(5, 2, 1, '20:00:00', '2018-03-04'),
(6, 3, 1, '22:00:00', '2018-03-04');
...
--
ALTER TABLE `bilety`
  MODIFY `IdB` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;

--
-- AUTO_INCREMENT dla tabeli `data_wystawienia`
--
ALTER TABLE `data_wystawienia`
  MODIFY `IdDW` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT dla tabeli `miejsca`
--
ALTER TABLE `miejsca`
  MODIFY `IdM` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=899;
